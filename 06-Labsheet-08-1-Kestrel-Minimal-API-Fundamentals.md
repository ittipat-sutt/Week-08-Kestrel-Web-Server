...
2. กลับไปที่หน้าเบราว์เซอร์แล้วกดปุ่ม **Refresh (F5)** สังเกตว่าเกิดอะไรขึ้น และอธิบายสั้นๆ ว่าทำไมจึงเป็นเช่นนั้น
   - **คำตอบ** มื่อกด Refresh (F5) หน้าเว็บจะไม่สามารถโหลดได้และแสดงข้อผิดพลาด เช่น “This site can’t be reached” เพราะการกด Ctrl + C ได้หยุดเซิร์ฟเวอร์ ทำให้ไม่มีโปรแกรมคอยรับคำขอจากเบราว์เซอร์แล้ว
